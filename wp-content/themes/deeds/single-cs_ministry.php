...
$church_meta = get_post_meta(get_the_ID() , 'sh_ministry_meta' , true) ;
			...
			<div class="row">
				...
				<div class="<?php  echo $col_class; ?> column">
					<div class="single-page">
						...
						<div class="meta">
							<ul>
								<li><i class="fa fa-reply"></i> <?php _e("Posted In " , 'wp_deeds'); ?> 
									<?php echo sh_get_terms( array( 'type' => 'ministry_category' ) );	?>
                                </li>
