...
class SH_import_export {
    ...
    function newdir($path, $mode = '0777', $recursive = false) {
        ...
        elseif (!mkdir($path, $mode, $recursive))
            wp_die(sprintf(__('System is not able to create backup directory, please create a directory named "backup" in "%s" manually and give it 0777 write permission.', THEME_NAME), $path));
