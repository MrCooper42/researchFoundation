...
class SH_Express_checkout {
	...
	function __construct() {
		$donation_data = get_option( 'wp_deeds' . '_theme_options' ); //printr($donation_data);
	...
	function hash_call( $methodName, $nvpStr ) {
		...
		//$this->API_UserName="shahbaz_ahmed98-facilitator_api1.yahoo.com";
		//$API_Password="1378028835";
		//$API_Signature="AKRKg7WOTdG07scdT9XjBbw3pATmA4wSsfplC-53DiEYe.3qxlnwkT5p";
