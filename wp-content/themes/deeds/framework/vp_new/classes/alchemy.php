...
{
	require_once get_template_directory().'/framework/vp_new/classes/MetaBox.php';//VP_FileSystem::instance()->resolve_path('includes', 'wpalchemy/MetaBox');
}
...
class VP_MetaBox_Alchemy1 extends WPAlchemy_MetaBox1
{
	...
	function _render_repeating_group($group)
	{
		...
		$html .= '<a href="#" class="button button-primary docopy-' . $name . '" style="width: 200px; margin: 0px auto;">'. __('Add More ', 'wp_deeds') . '' . $group['title'] . '</a>';
		$html .= '</div>';
