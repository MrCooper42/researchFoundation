<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Import', 'wp_deeds') ?>
		</label>
		<div class="description">
			<p><?php _e('Import Options', 'wp_deeds') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'wp_deeds') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Export', 'wp_deeds') ?>
		</label>
		<div class="description">
			<p><?php _e('Export Options', 'wp_deeds') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'wp_deeds') ?>" />
				<span style="margin-left: 10px;">
