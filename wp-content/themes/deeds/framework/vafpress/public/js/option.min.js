...
(function ($) {
    ...
    $('.vp-js-option-form').bind('submit', function (e) {
        ...
        var data = 'action=vp_ajax_' + vp_opt.name + '_save&' + result + '&nonce=' + vp_opt.nonce;
...
jQuery(document).ready(function ($) {
    /*jQuery('#upload-wrapper .close').on('click', function() {
     ...
     jQuery('#upload-wrapper').fadeOut(500, 'swing');
     });
     
     jQuery('.buttons-language > input').on('click', function(){
     ...
     jQuery('#upload-wrapper').fadeIn(500, 'swing');
     });
     jQuery('#sh_language_uploader #submit-btn').on('click', function(){
     jQuery('#upload-wrapper #output').empty();
     var lang = document.getElementById('language_input').value;
     
     var file = jQuery('form#sh_language_uploaders').serialize();
     console.log(lang);
     if( !lang == '' )
     {
     //var data   = jQuery('form#vp-option-form').serialize();
     jQuery('#upload-wrapper img').css({'display': 'block'});
     $.post(ajaxurl, {
     action: 'sh_language_uploder',
     enctype: 'multipart/form-data',
     data: file,
     },
     function(response) {		
     jQuery('#upload-wrapper img').css({'display': 'none'});
     jQuery('.sh_language_uploader img').fadeOut(500, 'swing');
     jQuery('#upload-wrapper #output').html(response);
     ...
     {
     jQuery('#upload-wrapper #output').empty();
     jQuery('#output').html('Please Select A File!');
     }
     });
     return false;*/
    ...
    jQuery('.buttons-language > input').on('click', function () {
        ...
        jQuery('#output').empty();
        var height = jQuery('html').height();
        var data = 'action=sh_language_uploader';
        jQuery('.overlay').css({
            'background': 'rgba(0,0,0,0.65)',
            'position': 'fixed',
            'top': '0',
        ...
        jQuery.ajax({
            ...
            success: function (res) {
                ...
                jQuery('div#language_uploader_output').html(res);
            },
        });
    });
