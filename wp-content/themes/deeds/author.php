...
$title = (sh_set($theme_options, 'author_page_title')) ? sh_set($theme_options, 'author_page_title') : '';
$subtitle = (sh_set($theme_options, 'author_page_subtitle')) ? sh_set($theme_options, 'author_page_subtitle') : '';
$bg = (sh_set($theme_options, 'author_page_bg')) ? 'style=background:url('.sh_set($theme_options, 'author_page_bg').');' : '';
$sidebar = (sh_set( $theme_options, 'author_page_sidebar')) ? sh_set( $theme_options, 'author_page_sidebar') : "";
$position = (sh_set($theme_options, 'author_page_sidebar_position') != '' && $sidebar) ? sh_set( $theme_options, 'author_page_sidebar_position') : "";
...
<?php if ( sh_set($theme_options, 'show_author_banner') ) : ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="blog-detail">
                                        ...
                                        <?php if(sh_set($theme_options, 'show_author_date') ) : ?>
